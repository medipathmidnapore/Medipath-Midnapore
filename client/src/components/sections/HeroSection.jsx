  ...
  return (
    <section className="hero-wrapper">
      ...
      >
        ...
        <div className="hero-card-left" style={{ position: 'absolute', bottom: '12%', left: '50%', transform: 'translateX(-50%)', zIndex: 2, width: 'max-content', maxWidth: '90%' }}>
          <div style={{
      ...
      >
        ...
        <div className="hero-card-right" style={{ position: 'absolute', bottom: '12%', left: '50%', transform: 'translateX(-50%)', zIndex: 2, width: 'max-content', maxWidth: '90%' }}>
          <div style={{
            background: 'rgba(255,255,255,0.92)',
            backdropFilter: 'blur(16px)',
            WebkitBackdropFilter: 'blur(16px)',
